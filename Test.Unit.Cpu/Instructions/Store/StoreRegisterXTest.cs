...
{
    public sealed record StoreRegisterXTest
    {
        #region Properties
        private StoreRegisterX Subject { get; }
        #endregion

        #region Constructors
        public StoreRegisterXTest()
        {
            this.Subject = new StoreRegisterX();
        }
        #endregion
        ...
        [Fact]
        public void Execute_ZeroPageYAddress_ReadWritesValue()
        {
            const byte value = 1;
            const ushort address = 2;
