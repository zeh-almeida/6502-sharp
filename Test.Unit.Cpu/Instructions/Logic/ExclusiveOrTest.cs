...
{
    public sealed record ExclusiveOrTest : IClassFixture<ExclusiveOr>
    {
        #region Properties
        private ExclusiveOr Subject { get; }
        #endregion

        #region Constructors
        public ExclusiveOrTest(ExclusiveOr subject)
        {
        ...
        {
            const byte value = 0b_0000_1100;
            const byte accumulator = 0b_0000_1100;
            const byte result = 0b_0000_0000;

            var stateMock = SetupMock(0x49, accumulator);
        ...
        public void Execute_ZeroPage_Compares()
        {
            ...
            var stateMock = SetupMock(0x45, accumulator);
        ...
        public void Execute_ZeroPageX_Compares()
        {
            ...
            var stateMock = SetupMock(0x55, accumulator);
        ...
        public void Execute_Absolute_Compares()
        {
            ...
            var stateMock = SetupMock(0x4D, accumulator);
        ...
        public void Execute_AbsoluteX_Compares()
        {
            ...
            var stateMock = SetupMock(0x5D, accumulator);
        ...
        public void Execute_AbsoluteY_Compares()
        {
            ...
            var stateMock = SetupMock(0x59, accumulator);
        ...
        public void Execute_IndirectX_Compares()
        {
            ...
            var stateMock = SetupMock(0x41, accumulator);
        ...
        public void Execute_IndirectY_Compares()
        {
            ...
            var stateMock = SetupMock(0x51, accumulator);
