...
{
    public sealed record TransferStackXTest : IClassFixture<TransferStackX>
    {
        #region Properties
        private TransferStackX Subject { get; }
        #endregion

        #region Constructors
        public TransferStackXTest(TransferStackX subject)
        {
