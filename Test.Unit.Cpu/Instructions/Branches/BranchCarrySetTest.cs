...
{
    public sealed record BranchCarrySetTest : IClassFixture<BranchCarrySet>
    {
        #region Properties
        private BranchCarrySet Subject { get; }
        #endregion

        #region Constructors
        public BranchCarrySetTest(BranchCarrySet subject)
        {
