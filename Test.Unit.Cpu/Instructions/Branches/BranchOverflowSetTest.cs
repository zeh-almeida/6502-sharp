...
{
    public sealed record BranchOverflowSetTest : IClassFixture<BranchOverflowSet>
    {
        #region Properties
        private BranchOverflowSet Subject { get; }
        #endregion

        #region Constructors
        public BranchOverflowSetTest(BranchOverflowSet subject)
        {
