...
{
    public sealed record ClearCarryFlagTest : IClassFixture<ClearCarryFlag>
    {
        #region Properties
        private ClearCarryFlag Subject { get; }
        #endregion

        #region Constructors
        public ClearCarryFlagTest(ClearCarryFlag subject)
        {
