...
namespace Cpu.Instructions.Shifts
{
    ...
    public sealed class RotateRight : BaseInstruction
    {
        ...
        public RotateRight()
            : base(
                new OpcodeInformation(0x6A, 2, 1),
                new OpcodeInformation(0x66, 5, 2),
                new OpcodeInformation(0x76, 6, 2),
                new OpcodeInformation(0x6E, 6, 3),
                new OpcodeInformation(0x7E, 7, 3))
        { }
        #endregion
        ...
        private static byte Load(ICpuState currentState, ushort address)
        {
            return currentState.ExecutingOpcode switch
            {
                ...
                0x7E => currentState.Memory.ReadAbsoluteX(address),
