    ...
    public sealed class CompareAccumulator : BaseInstruction
    {
        ...
        private static ushort Load(ICpuState currentState, ushort address)
        {
            return currentState.ExecutingOpcode switch
            {
                ...
                0xDD => LoadExtraCycle(currentState, currentState.Memory.ReadAbsoluteX(address)),
                0xD9 => LoadExtraCycle(currentState, currentState.Memory.ReadAbsoluteY(address)),
                0xC1 => currentState.Memory.ReadIndirectX(address),
                0xD1 => LoadExtraCycle(currentState, currentState.Memory.ReadIndirectY(address)),
